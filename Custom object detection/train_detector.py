# USAGE
# python train_detector.py --xml mylib/faces_annotations.xml --detector mylib/detector.svm

# imglab -c mylib/faces_annotations.xml mylib/faces
# imglab mylib/faces_annotations.xml
